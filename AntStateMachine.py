...
pygame.display.set_caption("Food Finding")
...
ant_image_filename = 'assets/ant.png'
leaf_image_filename = 'assets/leaf.png'
spider_image_filename = 'assets/spider.png'
...
def run():
    ...
    ant_image = image_load(ant_image_filename).convert_alpha()
    leaf_image =image_load(leaf_image_filename).convert_alpha()
    spider_image = image_load(spider_image_filename).convert_alpha()
